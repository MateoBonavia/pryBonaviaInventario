...
namespace pryBonaviaInventario
{
    internal class clsConexionBDSQL
    {
        ...
        //public void agregarProducto(Int32 cod, String nombre, Int32 categoria, Int32 precio, Int32 stock, String observaciones)
        //{
        //    // Creo en memoria el objeto
        //    comandoBaseDatos = new SqlCommand();
        //    // Cargo la conexion a la base
        ...
        //    comandoBaseDatos.CommandType = System.Data.CommandType.Text;
        //    // sentencia SQL para consultar la base
        //    comandoBaseDatos.CommandText = "INSERT INTO productos (codigo, nombre, categoria, precio, stock, descripcion) VALUES (?, ?, ?, ?, ?, ?)";
